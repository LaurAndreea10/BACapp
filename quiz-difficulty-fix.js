(() => {
  ...
  function loadExtraQuizModules() {
    loadScriptOnce('launch-readiness-loader-fallback', '/BACapp/launch-readiness.js?v=20260427');
    loadScriptOnce('bac-ux-upgrade-loader-fallback', '/BACapp/bac-ux-upgrade.js?v=20260427');
